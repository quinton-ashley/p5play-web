...
[Scratch](https://scratch.mit.edu/)は 8 歳から 11 歳の生徒には素晴らしいですが、より高い期待を持つ年齢の生徒には Scratch では満たせません。Scratch には内蔵の物理エンジンがないため、p5play で簡単に作れるような、斜面を転がるボールでさえ、多くの数学を必要とし、Scratch のブロックベースの環境では非常に面倒な実装が必要です。

Scratch のウェブサイトに掲載されているゲームは生徒にとって刺激的かもしれませんが、ほとんどが大人によって作成されたことに気づくと落胆します。生徒が Scratch で印象的なゲームを作ろうと本当に決心している場合、YouTube のチュートリアルからコピペするために 20 時間を費やす必要があります。

その一方で、14 歳の生徒が定期的に p5play でできることに私は感心しています！
