...
コーポレーションはゲーム開発の芸術に独占すべきではありません！

インターネットの初期には、Adobe Flash が趣味のある人々によって作られたゲームの制作を容易にしました。しかし、インターネットが商業化され、Flash のような簡単なツールが段階的に廃止されるにつれて、ゲーム開発の芸術はよりアクセスしにくくなりました。今日ではマイクロトランザクションやルートボックスがほぼすべての大きなリリースを汚染しており、主要なパブリッシャーは利益のためにプレイヤーを搾取することに興味を持っているように見えます。芸術を作ることよりも利益を追求しています。

p5play は、このメディアを学生、教育者、およびインディーゲーム開発者によりアクセス可能にするために作成されました。現在、リメイクやインスピレーションに欠ける続編に支配されている業界で、私たちの希望は、p5play がオリジナルの芸術を作成し、政治的に充満したアートさえも作成されることです。これは仮想世界を使用して人々に現実について批判的に考えさせるものです。

**「Only the best is good enough」** - レゴの創設者、ゴドフレッド・キルク・クリスチャンセン

p5play は、Scratch と Unity のような専門的なゲームエンジンとの間の溝を明確に埋めるものであり、これらは初心者には複雑すぎ、一般的な CS 教育には適していません。
