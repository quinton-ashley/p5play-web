...
¡企業がゲーム開発の芸術に独占権を持つべきではありません！p5play は、このメディアを学生、教育者、独立開発者によりアクセスしやすくするために作成されました。

インターネットの初期には、Adobe Flash がファンがゲームを開発し、共有し、これまで以上に観客を引き付けるのを容易にしました。しかし、Flash が時代遅れになって以来、ゲームはより商業化されました。Meta（Facebook）や Apple などの企業は、マイクロトランザクションやガチャを含む毒入りのゲームを積極的にプロモーションしました。これらは利益を最大化するために設計されたメカニズムです。ファンは置き去りにされました。今、プレイヤーたちは搾取されることに嫌気がさしており、独創性を求めていますが、洗練された形で提供されたいと思っています。

それが Roblox、Minecraft for Education、Fortnite などが、若い開発者がゲームモードや体験を作成し共有できるようにする理由です。これらは潜在的な大規模な観客を約束しますが、これらのプラットフォームは悪質であり、芸術的な自由を制限し、開発者を搾取しています。これらの企業は定期的に彼らの好みではないコンテンツを削除または隠し、説明や救済なしにこれを行うことができます。これらの企業は政治的なアートを明確に禁止し、数十年にわたってそのゲームの寿命を延ばすために収益化できる非論争的なコンテンツのみを望んでいます。

しかし、仮想世界やゲームシステムは、政治的表現の強力なツールです。p5play は特に、若いゲームデザイナーが、現実世界とそれを支配するシステムについて批判的に考えるようプレイヤーに挑戦する芸術を作成するのを支援するために作成されました。

**"Only the best is good enough"** - レゴの創業者 Godtfred Kirk Christiansen

p5play は間違いなく、Scratch と Unity のようなプロのゲームエンジンとの間の隔たりを埋めます。これらは初心者には複雑すぎ、一般的なコンピュータサイエンスの教育で使用するには特化しすぎています。
