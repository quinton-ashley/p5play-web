...
このページの例が、p5play で利用可能な移動オプションの一部を理解するのに役立ったことを願っています。しかし、これらはより複雑な移動パターンのためのビルディングブロックに過ぎません。

あなたのゲームのための最適な解決策を見つけるためには、しばしばそれらを創造的な方法で試す必要があります！
...
デフォルトのパレットはデフォルトの [p5.js の色](https://p5js.org/reference/#/p5/color) を使用しますが、色パレットもカスタマイズできます！
...
また、`friction` が円形の物理的な衝突体に影響を与えると思うかもしれませんが、残念ながらそうではありません！代わりに `rotationDrag` プロパティを使用してください。
