...
## ¡Únete a más de 40,000 usuarios activos!
...
La biblioteca gráfica [p5.js](https://p5js.org/) ya es popular entre los educadores de CS, por lo que p5play es una adición natural a muchos currículos.

p5play es excelente para enseñar conceptos de Programación Orientada a Objetos. En lugar de manipular datos abstractos en una consola, los estudiantes pueden crear objetos de juego llamados [sprites](../learn/sprite.html) con los que pueden ver e interactuar físicamente. Los estudiantes también pueden aprender sobre arreglos y herencia similar a clases de manera intuitiva usando [grupos](../learn/group.html).

p5play también es completamente basado en código, por lo que los estudiantes no necesitan una aplicación de editor especializada para usarlo (a diferencia de Unity). Con p5play, los estudiantes adquieren habilidades prácticas de programación en JavaScript transferibles y experiencia con editores de código en línea o IDEs estándar de la industria como [Visual Studio Code](https://code.visualstudio.com/).

p5play también está bien diseñado y documentado. Revisa las [páginas de Aprender](../learn), un recurso gratuito lleno de ejemplos interactivos y ejercicios.
...
¡Sí! Puedes usar p5play comercialmente en proyectos de código cerrado bajo los términos de la [Licencia Profesional de p5play](https://github.com/quinton-ashley/p5play-web/blob/main/pro/LICENSE.md), que está disponible para los miembros de [Patreon](https://www.patreon.com/p5play).
...
Paolo Pedercini, creador de p5.play (versión 1), quien confió en mí para tomar el relevo del proyecto. [molleindustria.org](http://molleindustria.org)

Erin Catto, creador del simulador de física Box2D. [box2d.org](https://box2d.org)

Ali Shakiba, creador de planck.js, un puerto de JavaScript de Box2D usado detrás de escena por p5play. [piqnt.com/planck.js](https://piqnt.com/planck.js)
