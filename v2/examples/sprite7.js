...
function draw() {
	...
	if (frameCount % 10 == 0) {
		...
		let newSprite = createSprite(random(0, width), random(0, height));
		//assign a random appearance
		let rnd = floor(random(0, 4));

		if (rnd == 0) newSprite.addAnimation('img', 'assets/box0001.png');
		if (rnd == 1) newSprite.addAnimation('img', 'assets/ghost_standing0004.png');
		if (rnd == 2) newSprite.addAnimation('img', 'assets/cloud_breathing0001.png');
		if (rnd == 3) newSprite.addAnimation('img', 'assets/square.png');
